...
| <a name="input_stop_on_destroy"></a> [stop\_on\_destroy](#input\_stop\_on\_destroy) | Stop VM before destroying | `bool` | `true` | no |
...
| <a name="input_timeout_clone"></a> [timeout\_clone](#input\_timeout\_clone) | Timeout for clone operations (seconds) | `number` | `60` | no |
| <a name="input_timeout_create"></a> [timeout\_create](#input\_timeout\_create) | Timeout for create operations (seconds) | `number` | `60` | no |
...
| <a name="input_timeout_shutdown_vm"></a> [timeout\_shutdown\_vm](#input\_timeout\_shutdown\_vm) | Timeout for shutdown operations (seconds) | `number` | `60` | no |
| <a name="input_timeout_start_vm"></a> [timeout\_start\_vm](#input\_timeout\_start\_vm) | Timeout for start operations (seconds) | `number` | `60` | no |
| <a name="input_timeout_stop_vm"></a> [timeout\_stop\_vm](#input\_timeout\_stop\_vm) | Timeout for stop operations (seconds) | `number` | `60` | no |
